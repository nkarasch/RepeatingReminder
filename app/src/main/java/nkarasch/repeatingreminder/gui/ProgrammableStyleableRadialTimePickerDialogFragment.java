 ...
 *
 * Sloppily modified from android-betterpickers RadialTimePickerDialogFragment to allow setting theme colors programatically
 * https://github.com/code-troopers/android-betterpickers
 */
public class ProgrammableStyleableRadialTimePickerDialogFragment extends DialogFragment implements OnValueSelectedListener {
    ...
    private ProgrammableStyle mProgrammableStyle;
    ...
    public interface OnTimeSetListener {
         ...
         */
        void onTimeSet(ProgrammableStyleableRadialTimePickerDialogFragment dialog, int hourOfDay, int minute);
    }
    ...
    public ProgrammableStyleableRadialTimePickerDialogFragment() {
        ...
        mProgrammableStyle = new ProgrammableStyle();
    }

    public ProgrammableStyleableRadialTimePickerDialogFragment setThemeDark() {
        mStyleResId = R.style.BetterPickersRadialTimePickerDialog_Dark;
        return this;
    }


    public ProgrammableStyleableRadialTimePickerDialogFragment setThemeLight() {
        mStyleResId = R.style.BetterPickersRadialTimePickerDialog_Light;
        return this;
    }

    public ProgrammableStyleableRadialTimePickerDialogFragment setStyleProgramatically(ProgrammableStyle programmableStyle) {
        this.mProgrammableStyle = programmableStyle;
        return this;
    }
     ...
     */
    public ProgrammableStyleableRadialTimePickerDialogFragment setThemeCustom(int styleResId) {
    ...
    public ProgrammableStyleableRadialTimePickerDialogFragment setOnDismissListener(OnDialogDismissListener ondialogdismisslistener) {
        mDimissCallback = ondialogdismisslistener;
        return this;
    }

    public ProgrammableStyleableRadialTimePickerDialogFragment setOnTimeSetListener(OnTimeSetListener callback) {
        mCallback = callback;
        return this;
    }

    public ProgrammableStyleableRadialTimePickerDialogFragment setStartTime(int hourOfDay, int minute) {
    ...
    public ProgrammableStyleableRadialTimePickerDialogFragment setTitleText(String text) {
        mTitleText = text;
        return this;
    }

    public ProgrammableStyleableRadialTimePickerDialogFragment setDoneText(String text) {
        mDoneText = text;
        return this;
    }

    public ProgrammableStyleableRadialTimePickerDialogFragment setFutureMinutesLimit(Integer futureMinutesLimit) {
        this.mFutureMinutesLimit = futureMinutesLimit;
        return this;
    }

    public ProgrammableStyleableRadialTimePickerDialogFragment setPastMinutesLimit(Integer pastMinutesLimit) {
        this.mPastMinutesLimit = pastMinutesLimit;
        return this;
    }

    public ProgrammableStyleableRadialTimePickerDialogFragment setValidateDateTime(Calendar validateDateTime) {
        this.mValidateDateTime = validateDateTime;
        return this;
    }

    public ProgrammableStyleableRadialTimePickerDialogFragment setPickerDate(Calendar pickerDate) {
        this.mPickerDate = pickerDate;
        return this;
    }

    public ProgrammableStyleableRadialTimePickerDialogFragment setCancelText(String text) {
        mCancelText = text;
        return this;
    }

    public ProgrammableStyleableRadialTimePickerDialogFragment setForced24hFormat() {
        mIs24HourMode = true;
        return this;
    }

    public ProgrammableStyleableRadialTimePickerDialogFragment setForced12hFormat() {
        mIs24HourMode = false;
        return this;
    }
     ...
     */
    @Deprecated
    public ProgrammableStyleableRadialTimePickerDialogFragment setAutodetectDateFormat(Context context) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        int headerBgColor = (mProgrammableStyle.headerBgColor == -1) ? themeColors.getColor(R.styleable.BetterPickersDialogs_bpHeaderBackgroundColor, ContextCompat.getColor(getContext(), R.color.bpBlue)) : mProgrammableStyle.headerBgColor;
        int bodyBgColor = (mProgrammableStyle.bodyBgColor == -1) ? themeColors.getColor(R.styleable.BetterPickersDialogs_bpBodyBackgroundColor, ContextCompat.getColor(getContext(), R.color.bpWhite)) : mProgrammableStyle.bodyBgColor;
        int buttonBgColor = (mProgrammableStyle.buttonBgColor == -1) ? themeColors.getColor(R.styleable.BetterPickersDialogs_bpButtonsBackgroundColor, ContextCompat.getColor(getContext(), R.color.bpWhite)) : mProgrammableStyle.buttonBgColor;
        int buttonTextColor = (mProgrammableStyle.buttonTextColor == -1) ? themeColors.getColor(R.styleable.BetterPickersDialogs_bpButtonsTextColor, ContextCompat.getColor(getContext(), R.color.bpBlue)) : mProgrammableStyle.buttonTextColor;
        mSelectedColor = (mProgrammableStyle.selectedColor == - 1) ? themeColors.getColor(R.styleable.BetterPickersDialogs_bpHeaderSelectedTextColor, ContextCompat.getColor(getContext(), R.color.bpWhite)) : mProgrammableStyle.selectedColor;
        mUnselectedColor = (mProgrammableStyle.unselectedColor == - 1) ? themeColors.getColor(R.styleable.BetterPickersDialogs_bpHeaderUnselectedTextColor, ContextCompat.getColor(getContext(), R.color.radial_gray_light)) : mProgrammableStyle.unselectedColor;
        ...
        try {
            Method setTheme = RadialPickerLayout.class.getDeclaredMethod("setTheme", TypedArray.class);
            setTheme.setAccessible(true);
            setTheme.invoke(mTimePicker, themeColors);
    ...
    public void doneClickValidateAndCallback() {
        if (isSelectionTooFarInTheFuture()) {
            ...
            if (mCallback != null) {
                mCallback.onTimeSet(ProgrammableStyleableRadialTimePickerDialogFragment.this, mTimePicker.getHours(), mTimePicker.getMinutes());
            }
            dismiss();
        }
    }
    ...
    public class ProgrammableStyle {
        int headerBgColor = -1;
        int bodyBgColor = -1;
        int buttonBgColor = -1;
