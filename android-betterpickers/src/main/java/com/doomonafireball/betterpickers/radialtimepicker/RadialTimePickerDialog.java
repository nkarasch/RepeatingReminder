...
public class RadialTimePickerDialog extends DialogFragment implements OnValueSelectedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mSelectedColor = res.getColor(mThemeDark ? R.color.pink : R.color.blue);
        ...
        mHourView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                setCurrentItemShowing(HOUR_INDEX, Build.VERSION.SDK_INT > 15, false, true);
                tryVibrate();
            }
        });
        mMinuteView.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                setCurrentItemShowing(MINUTE_INDEX, Build.VERSION.SDK_INT > 15, false, true);
                tryVibrate();
            }
        });
        ...
        mDoneButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Removed dismiss(),
                // will call dismiss from onTimeSet callback
            }
        });
    ...
    public void onValueSelected(int pickerIndex, int newValue, boolean autoAdvance) {
        if (pickerIndex == HOUR_INDEX) {
            ...
            if (mAllowAutoAdvance && autoAdvance) {
                setCurrentItemShowing(MINUTE_INDEX, Build.VERSION.SDK_INT > 15, true, false);
